...
def train(Model, imgs_train, imgs_test, labels_train, labels_test, model_name="model0"):
    
    #model filename
    filename = f"determine_face/models/{model_name}.h5"
    ...
    pickle.dump(history, open(f"determine_face/models/{model_name}_history.pickle", "wb"), pickle.HIGHEST_PROTOCOL)
